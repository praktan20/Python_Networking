...
def main():
	...
	with FileTransfer(ssh_conn, source_file, dest_file, file_system=dest_file_system) as scp_transfer:
		...
		if check_mode:
			...
			module.exit_json(msg='Check mode: file would be changed on the remote device', changed = True)
		...
		if scp_transfer.verify_file():
			...
			module.exit_json(msg='File successfully transfered to remote device',changed=True)
